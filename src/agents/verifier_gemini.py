...
Your Goal: Write a standalone Python script that imports or defines the function
and runs a specific test case that you believe will FAIL.

Rules:
1. Identify the Weakness: Look for off-by-one errors, type mismatches, empty inputs, or recursion limits.
2. Write the Attack: Create a python script called 'attack.py'.
3. Assert Failure: The script should raise an Assertion Error or Crash if the bug exists.
