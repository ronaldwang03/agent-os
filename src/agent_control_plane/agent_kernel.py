...
class AgentKernel:
    ...
    def execute(self, request: ExecutionRequest) -> ExecutionResult:
        ...
        try:
            ...
            self._audit("execution_completed", {
                "request_id": request.request_id,
                "execution_time_ms": execution_time
            })
    ...
    def _get_required_permission_level(self, action_type: ActionType) -> PermissionLevel:
        ...
        elif action_type in [ActionType.FILE_WRITE, ActionType.DATABASE_WRITE,
                             ActionType.CODE_EXECUTION, ActionType.API_CALL,
